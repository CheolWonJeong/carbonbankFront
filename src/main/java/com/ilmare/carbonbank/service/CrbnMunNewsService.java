...
import com.ilmare.carbonbank.mapper.CrbnMunNewsMapper;
...
@Slf4j
@Service
public class CrbnMunNewsService {
	@Autowired
	public CrbnMunNewsMapper mapper;
	...
	public List<NewsCommonModel>  selectLatestList(String partyCd){
