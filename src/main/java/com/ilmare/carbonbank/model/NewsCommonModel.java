...
public class NewsCommonModel {
	...
	private String searchType;		//처리일시
    ...
    public void setBefImgSrcNm(String befImgSrcNm) {
        this.befImgSrcNm = befImgSrcNm;
    }

    public String getBefImgNailNme() {
        return befImgNailNm;
    }
    public void setBefImgNailNm(String befImgNailNm) {
        this.befImgNailNm = befImgNailNm;
    }
